...
namespace Codino_UserCredential.Repository.Migrations
{
    ...
    [Migration("20250516205725_FixToyActivationCode")]
    partial class FixToyActivationCode
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Codino_UserCredential.Repository.Models.Content.ToyActivationCode", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("ToyActivationCode", "content");
                });

            modelBuilder.Entity("Codino_UserCredential.Repository.Models.Content.ToyAvatar", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("RequiredToyLevel")
                        .HasColumnType("integer");

                    b.Property<int>("RequiredUserXp")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("ToyAvatar", "content");
                });

            modelBuilder.Entity("Codino_UserCredential.Repository.Models.Content.UserToy", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Codino_UserCredential.Repository.Models.Content.ToyActivationCode", b =>
                {
                    b.HasOne("Codino_UserCredential.Repository.Repositories.User", "ActivatedByUser")
                        .WithMany()
