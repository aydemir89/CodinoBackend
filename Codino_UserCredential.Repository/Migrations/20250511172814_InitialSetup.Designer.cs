...
namespace Codino_UserCredential.Repository.Migrations
{
    ...
    [Migration("20250511172814_InitialSetup")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Codino_UserCredential.Repository.Models.Content.Biome", b =>
                {
                    b.HasOne("Codino_UserCredential.Repository.Models.Content.WorldMap", null)
                        .WithMany()
                        .HasForeignKey("WorldMapId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Codino_UserCredential.Repository.Models.Content.WorldMap", "WorldMap")
                        .WithMany()
                        .HasForeignKey("WorldMapid")
