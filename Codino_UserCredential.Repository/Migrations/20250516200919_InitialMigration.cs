        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActiveAvatarId = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    RequiredToyLevel = table.Column<int>(type: "integer", nullable: false),
                    RequiredUserXp = table.Column<int>(type: "integer", nullable: false),
                    StatusId = table.Column<int>(type: "integer", nullable: false),
                    CreaUserId = table.Column<int>(type: "integer", nullable: false),
                    creaDateTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    ModifDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ToyAvatar", x => x.id);
                    table.ForeignKey(
                        name: "FK_ToyAvatar_Toy_ToyId",
                        column: x => x.ToyId,
                        principalSchema: "content",
                        principalTable: "Toy",
                        principalColumn: "id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserToy", x => x.id);
                    table.ForeignKey(
                        name: "FK_UserToy_Toy_ToyId",
                        column: x => x.ToyId,
                        principalSchema: "content",
                        principalTable: "Toy",
                        principalColumn: "id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserToy_ToyId",
                schema: "content",
                table: "UserToy",
                column: "ToyId");

            migrationBuilder.CreateIndex(
                name: "IX_UserToy_UserId",
                schema: "content",
                table: "UserToy",
                column: "UserId");
        }
